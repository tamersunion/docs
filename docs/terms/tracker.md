...
## 如何使用？
追踪器仅通过默认HTTPS端口（443）和HTTPS协议响应。你可以创建一个种子并添加追踪器的URL [https://tracker.tamersunion.org:443/announce](https://tracker.tamersunion.org:443/announce) ，或者在你的BitTorrent客户端上添加追踪器的URL。追踪器被Cloudflare CDN所保护，请使用域名（tracker.tamersunion.org）而非IP地址连接，此域名解析的IP地址由Cloudflare提供，你不能直接使用该IP地址连接追踪器。
